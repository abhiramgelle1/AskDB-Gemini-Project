-- AskDB Google Cloud SQL Setup Script
-- Run this script in your Google Cloud SQL database after creating it

-- Create database (if not already created via console)
...
CREATE TABLE IF NOT EXISTS programs (
    ...
    program_identifier VARCHAR(100) UNIQUE,
...
('Data Science Bootcamp', 1, 'John Doe', '2024-01-15', '2024-06-15', TRUE),
('Web Development Course', 2, 'Jane Smith', '2024-02-01', '2024-05-01', TRUE),
('Machine Learning Advanced', 3, 'Bob Johnson', '2024-03-01', '2024-08-01', TRUE);
